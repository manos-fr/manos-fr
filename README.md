...
[![Medium](https://img.shields.io/badge/-@manos__kakarakis-12100E?style=flat&logo=medium&logoColor=white)](https://medium.com/@manos_kakarakis)
[![Email](https://img.shields.io/badge/-manoskakarakis@gmail.com-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:manoskakarakis@gmail.com)
...
| Project | Description |
|---------|-------------|
| [**claude-mem**](https://github.com/manos-fr/claude-mem) | Claude Code plugin that captures session context, compresses it with AI, and injects relevant context back into future sessions |
| [**openclaude**](https://github.com/manos-fr/openclaude) | Claude Code opened to any LLM — OpenAI, Gemini, DeepSeek, Ollama, and 200+ models via OpenAI-compatible API shim |
| [**claw-code**](https://github.com/manos-fr/claw-code) | Harness tools for Claude Code — now being rewritten in Rust |
...
| **Blockchain DApp** | Decentralized application on Sui blockchain using Move smart contracts for digital asset management | Sui, Move, React, Web3 |

#### Other

| Project | Description |
|---------|-------------|
| [**manos-cv**](https://github.com/manos-fr/manos-cv) | Personal portfolio site with React + Vite + Tailwind, dark mode, knowledge graph dashboard, and PDF export |
| [**spark-monorepo**](https://github.com/manos-fr/spark-monorepo) | TypeScript monorepo |
| [**News & Weather Microservices**](https://github.com/manos-fr/News_Weather_Services_Python_Docker) | Python microservices architecture using Docker — Client → Nginx → API → microservices |
...
- **50+** students mentored at Masterschool
...
- **MSc Applied Informatics** — University of Macedonia (2020–2022)
- **Integrated Master, Surveying Engineering** — Aristotle University of Thessaloniki (2013–2020)
- **Sui Move Bootcamp** — Sui Foundation (2024)

---

### ✍️ Writing

📝 [Building Scalable Microservices with Python and Flask](https://medium.com/@manos_kakarakis/python-flask-scalable-microservices-using-docker-compose-and-nginx-load-balancer-e20d421b1ad6) — A deep dive into architecting microservices that can handle 100K+ daily requests while maintaining code quality.

---

<p align="center">
  <em>AI writes. AI reviews. I supervise and ship.</em>
</p>
